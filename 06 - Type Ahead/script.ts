...
const listEl: HTMLElement = document.querySelector(".suggestions");
...
function findMatch(wordToMatch: string, cities: string[]): void {
    listEl.innerHTML = "";
    if (wordToMatch) {
...
input.addEventListener("input", (e => findMatch((e.target as HTMLInputElement).value, cities)))
